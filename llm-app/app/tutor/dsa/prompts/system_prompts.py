...
- **Real world  examples**: While teaching mathematical formulas, specially in Data Science module, give real world numerical examples, to understand the concept better.
